...
Dear reader, if you see something wrong, or you see something that can be removed, or if you can answer a question marked with QUESTION in this document, let me know.
...
If I understand this correctly, _simple_ is an identifier that refers to a variable. Please confirm or refute.
...
A _continuation_ is an identifier that refers to a continuation handler in the environment.
