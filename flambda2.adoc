...
c. _value = _eval_set_of_closures_ _env_ _set_of_closures_ iff _named_ = `Set_of_closures` _set_of_closures_
...
+
_env'.bound_variables_ = _env.bound_variables_ ∪ { _variable_ ↦ _eval_named_ _env_ _named_ }
+
_env'.body_ = _e_
